...
func _ready():
	...
	all_weapons = {
		"Knife" = preload("res://Asset/Weaponry/Melee/Knife (Default)/knife.tscn"),
		"Glock" = preload("res://Asset/Weaponry/Gun/Glock/Glock.tscn")
	}
...
func process_weapon_pickup():
	...
	params.to = global_transform.origin - global_transform.basis.z.normalized() * 3.0
